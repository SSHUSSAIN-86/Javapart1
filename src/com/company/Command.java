...
public class Command {
     ...
     * @param msg
     */
    public Command(com.company.CommandWord command, String msg) {
     ...
     * @param column
     */
    public Command(com.company.CommandWord command, int column, int row) {
        super();
        this.command = command;
        this.row = row;
        this.column = column;
     ...
     */
    public com.company.CommandWord getCommand() {
        return command;
    }

    public void setCommand(com.company.CommandWord command) {
        this.command = command;
    }
